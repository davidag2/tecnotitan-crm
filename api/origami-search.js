...
function personPrompt(search) {
  ...
  return [
    ...
    "Official pitch channel detection: search for public official inbound emails or mandatory forms.",
...
async function saveRunResult(search, run) {
  ...
  if (status === "completed") {
    ...
    patch.result_profile = {
      ...
      accepts_pitches: profile.accepts_pitches || "unknown",
      accepts_founder_submissions: profile.accepts_founder_submissions || "unknown",
      accepts_inbound_deals: profile.accepts_inbound_deals || "unknown",
      accepts_cold_email: profile.accepts_cold_email || "unknown",
      outreach_openness_evidence: profile.outreach_openness_evidence || "",
      ...
      pitch_email_alias_type: profile.pitch_email_alias_type || "unknown",
      pitch_detection_evidence: profile.pitch_detection_evidence || "",
