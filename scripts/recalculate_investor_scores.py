...
def load_investor_opportunities() -> list[dict[str, object]]:
    return query_json(
        """
        ...
        FROM (
          ...
          WHERE opportunities.lead_type = 'investor'
...
def main() -> None:
    opportunities = load_investor_opportunities()
    print(f"Recalculando {len(opportunities)} oportunidades de inversionistas...")
